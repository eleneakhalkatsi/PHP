...
@section("seo")
<meta property="og:title" content="my first app">
 ...
 --}}
    ...
    @foreach ($data as $elem)
        {!! $elem['name']. " <p>" . $elem['description'] . " </p>"!!}
    @endforeach
@endsection
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="feature_static_wrapper">
                        <div class="feature_article_img">
                            <img class="img-responsive" src="blog/public/assets/img/feature-static1.jpg" alt="feature-top">
                        </div>
                        <!-- feature_article_img -->
